    ...
    <section class="features">
      <div class="container">
        ...
        <div style="position: relative; margin-top: 4rem; text-align: center">
          <div
            style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background: rgba(225, 190, 231, 0.1); border-radius: 9999px;">
            <span
              style="width: 0.5rem; height: 0.5rem; background: hsl(var(--primary)); border-radius: 50%; animation: pulse 2s infinite;"></span>
            <span
              style="font-family: 'Roboto', sans-serif; font-size: 0.875rem; color: hsl(var(--muted-foreground)); cursor: default;">
              Mais de 50 funcionalidades para facilitar seu trabalho
            </span>
            <span
              style="width: 0.5rem; height: 0.5rem; background: hsl(var(--secondary)); border-radius: 50%; animation: pulse 3s infinite;"></span>
          </div>
        </div>
      </div>
    </section>
