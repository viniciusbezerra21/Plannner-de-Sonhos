...
function getEventos($pdo) {
    try {
        ...
        // Organiza os eventos por data no formato esperado pelo JavaScript
        $eventosPorData = [];
        foreach ($eventos as $evento) {
            ...
            $eventosPorData[$data][] = [
                ...
                'tipo' => $evento['descricao'] // usando descrição como tipo
            ];
        }
...
function criarEvento($pdo) {
    try {
        ...
        $usuario_id = $input['usuario_id'] ?? 1; // Você pode ajustar conforme seu sistema de usuários
