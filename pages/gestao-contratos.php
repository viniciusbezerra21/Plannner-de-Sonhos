...
<html lang="pt-BR">
  <head>
    ...
    <title>Gestão de Contratos - WeddingEasy</title>
        ...
        <div class="container">
          <div class="page-header">
            ...
            <p class="page-description">
              Visualize, baixe e mantenha todos os contratos organizados em um
              só lugar.
            </p>
          </div>
          ...
          >
            ...
            >
              <iframe
                src="../Docs/contrato-flor-arte.pdf"
                style="
                  width: 100%;
                  height: 200px;
                ...
                "
              ></iframe>
              <h3 style="margin-bottom: 0.5rem">Contrato - Flor & Arte</h3>
              <p
                style="
                  color: hsl(var(--muted-foreground));
                  font-size: 0.9rem;
                ...
                "
              >
                Decoração | Assinado em: 05/08/2025 | Válido até: 05/08/2026
              </p>
              <a
                href="../Docs/contrato-flor-arte.pdf"
                download
                class="btn-primary"
                style="
                  text-decoration: none;
            ...
            >
              <iframe
                src="../Docs/contrato-sabor-festa.pdf"
                style="
                  width: 100%;
                  height: 200px;
                  border-radius: 0.5rem;
                ...
                "
              ></iframe>
              <h3 style="margin-bottom: 0.5rem">Contrato - Sabor & Festa</h3>
              <p
                style="
                  color: hsl(var(--muted-foreground));
                  font-size: 0.9rem;
                ...
                "
              >
                Buffet | Assinado em: 10/07/2025 | Válido até: 10/07/2026
              </p>
              <a
                href="../Docs/contrato-sabor-festa.pdf"
                download
                class="btn-primary"
                style="
                  text-decoration: none;
            ...
            >
              <iframe
                ...
                "
              ></iframe>
              <h3 style="margin-bottom: 0.5rem">Contrato - FotoLux</h3>
              <p
                style="
                  color: hsl(var(--muted-foreground));
                  font-size: 0.9rem;
                ...
                "
              >
                Fotografia | Assinado em: 20/06/2025 | Válido até: 20/06/2026
              </p>
              <a
                href="../Docs/contrato-fotolux.pdf"
                download
                class="btn-primary"
                style="
                  text-decoration: none;
