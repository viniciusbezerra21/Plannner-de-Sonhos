...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_POST['nome']) || !isset($_POST['nome_conj']) || !isset($_POST['email']) || !isset($_POST['senha'])) {
        ...
        // ✅ CORRETO: Redireciona para o index.php na RAIZ (onde está o formulário)
        header("Location: ../index.php");
        exit;
    }

    // ✅ Verificar se email já existe ANTES de criptografar
    $email_limpo = strtolower(trim($_POST['email']));
    
    // Buscar todos os emails e descriptografar para comparar
    ...
    if ($emailJaExiste) {
        ...
        $conn->close();
        // ✅ CORRETO: Volta para index.php na raiz
        header("Location: ../index.php");
        exit;
    }

    // ✅ Criptografar dados para inserção
    ...
    if ($stmt->execute()) {
        ...
        // ✅ Buscar dados completos do usuário recém cadastrado
        ...
        // ✅ Fazer login automático após cadastro (igual ao seu padrão do login)
        $_SESSION['logado'] = true;
        $_SESSION['usuario_id'] = $usuario_id;
        $_SESSION['nome'] = $_POST['nome'];
        $_SESSION['email'] = $email_limpo;
        
        // ✅ Definir dados do usuário para exibição no index (com dados descriptografados)
        $_SESSION['usuario_logado'] = [
            'id' => $usuario_id,
            'nome' => $_POST['nome'], // Usar dados limpos do formulário
        ...
        // ✅ CORRETO: Redirecionar para index.php já logado
        header("Location: ../index.php");
        exit;
